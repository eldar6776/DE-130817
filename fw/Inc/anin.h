...
#define ANIN_STARTUP_TIME					100			// 100 ms analog signal settling time
#define NTC_OPEN_VOLTAGE_DEFAULT			0x0bc0		// NTC sensor open min. voltage 
#define NTC_BYPASS_VOLTAGE_DEFAULT			0x0010		// NTC sensor short max. voltage 
#define NTC_WARNING_TEMPERATURE_DEFAULT		0x0589		// NTC temperatue warning limit value  
#define NTC_SHUTDOWN_TEMPERATURE_DEFAULT	0x0422		// NTC temperatue shutdown limit value 
#define SUPPLY_VOLTAGE_SHUTDOWN_DEFAULT		0x0480		// power supply voltage shutdown limit value 
