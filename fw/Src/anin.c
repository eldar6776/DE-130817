...
void ANIN_Service(void)
{
	...
	{
		ANIN_INIT						= 0x00,
		ANIN_SUPPLY_VOLTAGE				= 0x01,
		ANIN_HEATSINK_TEMPERATURE		= 0x02
	...
	switch(ANIN_ServiceState)
	{
		...
		case ANIN_INIT:
		{
			ntc_open_voltage = 0x0bc0;
			ntc_bypass_voltage = 0x0010;
			psu_shutdown_voltage = 0x0480;			
			ntc_warning_temperature = 0x0589;
			ntc_shutdown_temperature = 0x0422;
